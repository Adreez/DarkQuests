...
public class SQLGetter {
	...
	public void createTable() {
		...
		try {
			ps = Main.SQL.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS " + table + " (NICK VARCHAR(100),UUID VARCHAR(100),COMPLETEDQUESTS INT(100),ACTIVEQUEST INT(100),PRIMARY KEY (NICK))");
			ps.executeUpdate();
	...
	public void getActiveQuest(String nick) {
		try {
